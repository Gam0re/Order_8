...
async def registration_name(message: types.Message, state: FSMContext):
    ...
    await message.answer('Введите свой номер телефона в формате +7хххххххххх', reply_markup=kb.settings_back_kb)
